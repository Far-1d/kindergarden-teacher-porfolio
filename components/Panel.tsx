            ...
            {posts.map(post => (    
                <tr key={post._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td className="px-2 sm:px-6 py-4 text-right">
                      {processingUpdateId == post._id ? (
                        <button onClick={()=>{handleUpdate(post._id)}} className="font-medium text-indigo-500 dark:text-indigo-500 hover:underline">save</button>
                      ) : (
                    ...
                    <td className="px-2 sm:px-6 py-4 text-right">
                        <button onClick={()=>{handleDelete(post._id)}} className="font-medium text-orange-500 dark:text-orange-500 hover:underline">delete</button>
                    </td>
                </tr>
            ))}
            </tbody>
